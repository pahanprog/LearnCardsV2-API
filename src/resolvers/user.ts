...
export class UserResolver {
  ...
  async forgotPassword(
    ...
    await sendEmail(
      email,
      `<div>Мы получили запрос на восстановления пароля вашего профиля в приложении LearnCards, чтобы изменить пароль пройдите по ссылке ниже, если вы не запрашивали смену пароля, то игнорируйте это письмо.<div><a href="${link}">Сменить пароль</a>`
    );
